...
basic_url = 'https://gammaray.msfc.nasa.gov/batse/grb/catalog/current/tables/basic_table.txt'
durn_url = 'https://gammaray.msfc.nasa.gov/batse/grb/catalog/current/tables/duration_table.txt'

# Brightnesses are in two tables; 4B and new in 5Bp.
bright_url4 = 'https://gammaray.msfc.nasa.gov/batse/grb/catalog/current/tables/flux_table_4b.txt'
bright_url5 = 'https://gammaray.msfc.nasa.gov/batse/grb/catalog/current/tables/flux_table.txt'

# Comments are only available for 4B bursts.
comments_url4 = 'https://gammaray.msfc.nasa.gov/batse/grb/catalog/4b/tables/4br_grossc.comments'


# COSSC FTP site for trigger data:
#trigger_url = 'ftp://legacy.gsfc.nasa.gov/compton/data/batse/trigger/'
trigger_url = 'https://heasarc.gsfc.nasa.gov/FTP/compton/data/batse/trigger/'
...
ascii64_url = 'https://heasarc.gsfc.nasa.gov/FTP/compton/data/batse/ascii_data/64ms/'
